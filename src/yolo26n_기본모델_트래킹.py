...
# ==========================================
# 2. YOLO 기본 모델 로드 (yolo26n.pt)
# ==========================================
print("🧠 YOLO 기본 모델 로드 중 (yolo26n.pt)...")
#model = YOLO("d:/opencv_class/yolo26n.pt")
model = YOLO("d:/opencv_class/yolo26s.pt")
#model = YOLO("d:/opencv_class/yolo26m.pt")
#model = YOLO("d:/opencv_class/yolo26l.pt")
#model = YOLO("d:/opencv_class/yolo26x.pt")
...
while True:
    ...
    # YOLO 추론
    # ==========================================
    # 클래스 선택 (80이면 모든 클래스 탐지, 아니면 해당 클래스만 탐지)
    ...
    cv2.imshow("YOLO Object Tracker (COCO)", frame)
